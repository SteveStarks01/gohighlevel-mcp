...
class CalendarCreate(BaseModel):
    """Model for creating a calendar"""

    locationId: str = Field(..., description="Location ID where the calendar will be created")
    name: str = Field(..., description="Calendar name")
    description: Optional[str] = Field(None, description="Calendar description")
    calendarType: Optional[str] = Field(None, description="Calendar type: round_robin, event, personal")
    eventType: Optional[str] = Field(None, description="Event type")
    eventTitle: Optional[str] = Field(None, description="Default event title template")
    eventColor: Optional[str] = Field(None, description="Event color hex code")
    slug: Optional[str] = Field(None, description="Calendar URL slug")
    slotDuration: Optional[int] = Field(None, description="Slot duration in minutes")
    slotInterval: Optional[int] = Field(None, description="Slot interval in minutes")
    isActive: Optional[bool] = Field(default=True, description="Is calendar active")
    autoConfirm: Optional[bool] = Field(None, description="Auto-confirm appointments")
    allowReschedule: Optional[bool] = Field(None, description="Allow appointment rescheduling")
    allowCancellation: Optional[bool] = Field(None, description="Allow appointment cancellation")

    model_config = {"populate_by_name": True}


class CalendarUpdate(BaseModel):
    """Model for updating a calendar"""
...
class CalendarGroup(BaseModel):
    """Calendar group model"""

    id: str = Field(..., description="Calendar group ID")
    name: str = Field(..., description="Calendar group name")
    locationId: str = Field(..., description="Location ID")
    description: Optional[str] = Field(None, description="Group description")
    isActive: Optional[bool] = Field(None, description="Is group active")
    calendars: Optional[List[str]] = Field(None, description="Calendar IDs in this group")
    createdAt: Optional[Union[datetime, str]] = Field(None, description="Creation timestamp")
    updatedAt: Optional[Union[datetime, str]] = Field(None, description="Last update timestamp")
...
class CalendarGroupList(BaseModel):
    """Result model for calendar groups list"""

    groups: List[CalendarGroup] = Field(
        default_factory=list, description="List of calendar groups"
    )
    count: int = Field(..., description="Count of groups in this response")
    total: Optional[int] = Field(None, description="Total count of groups")
