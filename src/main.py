...
from .mcp.tools.calendar_admin import _register_calendar_admin_tools
from .mcp.tools.forms import _register_form_tools
from .mcp.tools.businesses import _register_business_tools
from .mcp.tools.users import _register_user_tools
from .mcp.tools.campaigns import _register_campaign_tools
from .mcp.tools.workflows import _register_workflow_tools
from .mcp.tools.locations import _register_location_tools
from .mcp.tools.locations_extended import _register_locations_extended_tools
from .mcp.tools.links import _register_links_tools
from .mcp.tools.surveys import _register_surveys_tools
from .mcp.tools.oauth_management import _register_oauth_management_tools
from .mcp.tools.contact_assignment import _register_contact_assignment_tools
from .mcp.tools.products import _register_product_tools
from .mcp.tools.payments import _register_payment_tools
...
def register_all_tools():
    ...
    _register_calendar_admin_tools(mcp, get_client)
    _register_form_tools(mcp, get_client)
    _register_business_tools(mcp, get_client)
    _register_user_tools(mcp, get_client)
    _register_campaign_tools(mcp, get_client)
    _register_workflow_tools(mcp, get_client)
    _register_location_tools(mcp, get_client)
    _register_locations_extended_tools(mcp, get_client)
    _register_contact_assignment_tools(mcp, get_client)
    _register_links_tools(mcp, get_client)
    _register_surveys_tools(mcp, get_client)
    _register_oauth_management_tools(mcp, get_client)
    _register_product_tools(mcp, get_client)
    _register_payment_tools(mcp, get_client)
